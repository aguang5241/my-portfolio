...
const applications = [
  {
    ...
    description: 'An application for analyzing substitutional effects in high-entropy perovskites (HEPs), supporting compositional screening, property prediction, and performance optimization.',
    icon: Orbit,
  ...
  },
  {
    id: 2,
    name: 'LCO-Doper',
    title: 'LCO Dopant Analyzer',
    description: 'An application for analyzing dopant effects on LaCoO3 (LCO), supporting composition optimization and material performance enhancement.',
    icon: FlaskRound,
    color: 'from-green-500 to-teal-600',
    features: ['LaCoO3 Analysis', 'Dopant Effects', 'Composition Optimization', 'Performance Enhancement']
  },
  {
    id: 3,
    name: 'Interface-Maker',
    title: 'Custom Slab & Interface Generator',
    description: 'An application for generating customizable slabs and interfaces for first-principles simulations.',
    icon: SquaresExclude,
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-80 bg-black/20 backdrop-blur-xl border-r border-white/10 transform transition-transform duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
        <div className="p-6 text-white h-full overflow-y-auto">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="text-gray-300 text-sm">Stay Hungry, Stay Foolish & Stay Awesome!</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            {/* About Me */}
            <div className="border-b border-white/10 pb-4">
              <h3 className="text-lg font-semibold mb-3 text-blue-300">About Me</h3>
