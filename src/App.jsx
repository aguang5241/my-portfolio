...
import { Orbit, FlaskRound, SquaresExclude, Component, Store, Atom, Repeat, ChevronLeft, ChevronRight, Bot, MessageCircleMore} from 'lucide-react';
import app0 from './assets/app-0.png';
...
export default function RotatingAppShowcase() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      handleNext();
    }, 5000); // Rotate every N/1000 seconds
  ...
  const pauseAutoRotate = () => {
    ...
    setTimeout(() => {
      setAutoRotate(true);
    }, 5000); // Resume after N/1000 seconds
  };
  ...
  const handleLaunch = (appName) => {
    switch(appName) {
      case 'Masgent':
        window.open('https://github.com/aguang5241/Masgent', '_blank');
        break;
      case 'HEP-Explorer':
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-r from-[#0a0f2c] via-[#0b2451] to-[#073a59] bg-[length:200%_200%] animate-gradient-x flex relative overflow-hidden text-white">
      ...
      <div className="lg:ml-80 flex-1 flex flex-col items-center justify-center px-1 py-10">
